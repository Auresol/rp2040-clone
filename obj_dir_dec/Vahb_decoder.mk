...
#    make -f Vahb_decoder.mk

default: Vahb_decoder
...
VM_PREFIX = Vahb_decoder
# Module prefix (from --prefix)
VM_MODPREFIX = Vahb_decoder
...
include Vahb_decoder_classes.mk
...
tb_decoder.o: sim/tb_decoder.cpp 
	$(OBJCACHE) $(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST)  -c -o $@ $<

### Link rules... (from --exe)
Vahb_decoder: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
