...
// Data port:        CPU0-D → crossbar (1×11) → 2×SRAM bank + 9 peripherals.
//
...
localparam XBAR_D_NS = 11;  // slaves: 2 SRAM banks + 9 peripherals
...
// I-port: single entry, internally banked by addr[14]
